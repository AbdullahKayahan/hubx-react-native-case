...
import Svg, { SvgProps, ForeignObject, Circle, Path, Defs, ClipPath } from 'react-native-svg';
const SvgComponent = (props: SvgProps) => (
    <Svg viewBox="0 0 24 24" width={24} height={24} fill="none" {...props}>
        <ForeignObject width={0} height={0} x={0} y={0} />
        <Circle cx={12} cy={12} r={12} fill="#000" fillOpacity={0.4} data-figma-bg-blur-radius={8} />
        <Path
            fill="#fff"
